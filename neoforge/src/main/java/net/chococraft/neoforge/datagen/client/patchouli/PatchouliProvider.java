//package net.chococraft.neoforge.datagen.client.patchouli;
//
...
//				.addImagePage(ResourceLocation.fromNamespaceAndPath(Chococraft.MOD_ID, "textures/gui/entry/chocobo.png"))
...
//				.addSmeltingPage(ResourceLocation.fromNamespaceAndPath(Chococraft.MOD_ID, "chocobo_drumstick_cooked")).build()
//				.addSmokingPage(ResourceLocation.fromNamespaceAndPath(Chococraft.MOD_ID, "chocobo_drumstick_cooked_from_smoking")).build()
//				.addCampfirePage(ResourceLocation.fromNamespaceAndPath(Chococraft.MOD_ID, "chocobo_drumstick_cooked_from_campfire_cooking")).build()
//				.build()
//
//				//Add Feather entry
...
//				.addCraftingPage(ResourceLocation.fromNamespaceAndPath(Chococraft.MOD_ID, "red_gysahl")).build()
//				.build()
//
...
//				.addCraftingPage(ResourceLocation.fromNamespaceAndPath(Chococraft.MOD_ID, "pink_gysahl")).build()
//				.build()
//
...
//				.addImagePage(ResourceLocation.fromNamespaceAndPath(Chococraft.MOD_ID, "textures/gui/entry/gysahl.png"))
//				.setText("info.chococraft.book.gysahl_green.text2").setBorder(true).build()
//				.addCraftingPage(ResourceLocation.fromNamespaceAndPath(Chococraft.MOD_ID, "gysahl_green_to_seeds"))
...
//				.addCraftingPage(ResourceLocation.fromNamespaceAndPath(Chococraft.MOD_ID, "pickled_gysahl_raw")).build()
//				.addSmeltingPage(ResourceLocation.fromNamespaceAndPath(Chococraft.MOD_ID, "pickled_gysahl_cooked")).build()
//				.addSmokingPage(ResourceLocation.fromNamespaceAndPath(Chococraft.MOD_ID, "pickled_gysahl_cooked_from_smoking")).build()
//				.addCampfirePage(ResourceLocation.fromNamespaceAndPath(Chococraft.MOD_ID, "pickled_gysahl_cooked_from_campfire_cooking")).build()
//				.build()
//
...
//				.addCraftingPage(ResourceLocation.fromNamespaceAndPath(Chococraft.MOD_ID, "gysahl_cake")).build()
//				.build()
//
//				.build(); //Back to the bookbuilder
//
...
//				.addImagePage(ResourceLocation.fromNamespaceAndPath(Chococraft.MOD_ID, "textures/gui/entry/chocodisguise.png")).setBorder(true).build()
//				.addCraftingPage(ResourceLocation.fromNamespaceAndPath(Chococraft.MOD_ID, "choco_disguise_helmet"))
//				.setRecipe2(ResourceLocation.fromNamespaceAndPath(Chococraft.MOD_ID, "choco_disguise_chestplate")).build()
//				.addCraftingPage(ResourceLocation.fromNamespaceAndPath(Chococraft.MOD_ID, "choco_disguise_leggings"))
//				.setRecipe2(ResourceLocation.fromNamespaceAndPath(Chococraft.MOD_ID, "choco_disguise_boots")).build()
//				.build()
//
//				//Add Saddle entry
...
//				.addCraftingPage(ResourceLocation.fromNamespaceAndPath(Chococraft.MOD_ID, "chocobo_saddle"))
//				.setRecipe2(ResourceLocation.fromNamespaceAndPath(Chococraft.MOD_ID, "chocobo_saddle_alt")).build()
//				.addTextPage("info.chococraft.book.saddle.text2").build()
//				.addCraftingPage(ResourceLocation.fromNamespaceAndPath(Chococraft.MOD_ID, "chocobo_saddle_bags"))
//				.setRecipe2(ResourceLocation.fromNamespaceAndPath(Chococraft.MOD_ID, "chocobo_saddle_pack")).build()
//				.build()
//
//				//Add Whistle entry
...
//				.addCraftingPage(ResourceLocation.fromNamespaceAndPath(Chococraft.MOD_ID, "chocobo_whistle")).build()
//				.build()
//
//				.build(); //Back to the bookbuilder
//
...
//				.addCraftingPage(ResourceLocation.fromNamespaceAndPath(Chococraft.MOD_ID, "straw")).build()
//				.build()
//
//				.build(); //Back to the bookbuilder
//
